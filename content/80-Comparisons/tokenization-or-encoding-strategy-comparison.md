...
| [[UCE]] | Genes encoded via protein-LM (ESM2) embeddings; vocabulary-free. | Rosen 2023, bioRxiv (needs verification) | Gene identity comes from protein sequence, not a learned token table. | Expression-value handling needs verification. |
